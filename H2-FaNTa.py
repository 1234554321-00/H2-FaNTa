# =============================================================================
# SOLUTION: Fixed H2-FaNTa Implementation with Proper Node-Label Alignment
# =============================================================================
...
# =============================================================================
# FIXED: H2-FaNTa Framework with Proper Label Alignment
# =============================================================================

class H2FaNTaFramework(nn.Module):
    """Complete H2-FaNTa Framework integrating all four stages"""
...
def train_h2_fanta(model, incidence_matrices, node_features, labels, movie_ids,
                   num_epochs=100, learning_rate=0.001, device='cpu'):
    """FIXED: Train H2-FaNTa model with proper movie-label alignment"""
...
def evaluate_h2_fanta(model, incidence_matrices, node_features, labels, movie_ids,
                      evaluator, device='cpu'):
    """FIXED: Evaluate H2-FaNTa model with proper alignment"""
    model.eval()
    model = model.to(device)
    node_features = node_features.to(device)
    labels = labels.to(device)
...
class EnhancedEvaluator:
    """Comprehensive evaluation system for H2-FaNTa with MAE, RMSE, and ACC metrics"""
...
def run_comprehensive_evaluation(folder_path, num_runs=10):
    ...
    print("="*80)
    print("H2-FaNTa COMPREHENSIVE EVALUATION (FIXED VERSION)")
    print("H2-FaNTa: MAE, RMSE, ACCURACY EVALUATION (10 RUNS)")
    print("="*80)
...
def main():
    ...
    print("H2-FaNTa Framework Evaluation (FIXED VERSION)")
    ...
    try:
        ...
        print(f"\nFINAL SUMMARY - H2-FaNTa Performance:")
        print("=" * 60)
        ...
        try:
            if any(results[metric]['values'] for metric in primary_metrics if metric in results):
                ...
                csv_filename = 'h2_fanta_evaluation_results_fixed.csv'
